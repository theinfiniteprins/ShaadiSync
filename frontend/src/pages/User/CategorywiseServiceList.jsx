...
const CategoryInfo = ({ artistType, totalServices }) => {
  return (
    <div className="text-left mb-6">
      <h2 className="text-2xl font-bold text-gray-800">{artistType} ({totalServices.toLocaleString()})</h2>
  ...
  return (
    <div className="py-4 px-45">
      <nav className="text-gray-600 text-sm mb-4 text-left">
        <span className="cursor-pointer text-blue-500" onClick={() => navigate('/')}>Home</span> / <span className="capitalize">{artistType}</span>
      </nav>
